...
export default function App() {
    ...
    loadState().then(saved=>{
      ...
      const initial = saved || {
        ...
        images: {
          ...
          icons: [ base + "icons/facebook.png", base + "icons/linkedin.png", base + "icons/youtube.png" ]
        },
        accent: "#00E785"
      };
      setData(initial);
  ...
  const patch = (p)=>{
    setData(prev=>{ const updated = {...prev, ...p}; saveState(updated); return updated; });
  };
  ...
  const copyHtml = ()=>{
    ...
    sel.removeAllRanges();
    sel.addRange(range);
    try{ document.execCommand("copy"); alert("Signature copied! Paste into Gmail → Settings → Signature."); }
      ...
      <div className="max-w-[95%] mx-auto grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-12 lg:col-span-4">
          ...
          <button onClick={copyHtml} className="mt-6 px-5 py-3 bg-black text-white rounded-md inline-flex items-center gap-3">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 1H4a2 2 0 0 0-2 2v14" stroke="#00E785" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><rect x="8" y="5" width="13" height="13" rx="2" stroke="#00E785" strokeWidth="2"/></svg>
