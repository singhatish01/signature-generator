...
import SignaturePreviewCard from "./components/SignaturePreviewCard"; // <-- NEW
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-[95%] mx-auto grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-12 lg:col-span-4">
          ...
          <button
            onClick={copyHtml}
            className="mt-6 px-5 py-3 bg-black text-white rounded-md inline-flex items-center gap-3"
          >
            <svg
              width="16"
              height="16"
